    ...
    public partial class HPV : UserControl
    {
        ...
        public static HPV Instance
        {
             get
            {
                ...
                list = BLL.JudgeTempletBLL.GetListByName("HPV");
                if (list.Count > 0)
                {
                ...
                instance.testSheet = new Test_HPV();
        ...
        private void HPV_Load(object sender, EventArgs e)
        {
            start();
        ...
        private void BindFormlToObject()
        {
            ...
            testSheet._11 = list.Contains("11") ? true : false;
            testSheet._16 = list.Contains("16") ? true : false;
            testSheet._18 = list.Contains("18") ? true : false;
            testSheet._26 = list.Contains("26") ? true : false;
            testSheet._31 = list.Contains("31") ? true : false;
            testSheet._33 = list.Contains("33") ? true : false;
            testSheet._35 = list.Contains("35") ? true : false;
            testSheet._39 = list.Contains("39") ? true : false;
            testSheet._42 = list.Contains("42") ? true : false;
            testSheet._43 = list.Contains("43") ? true : false;
            testSheet._44 = list.Contains("44") ? true : false;
            testSheet._45 = list.Contains("45") ? true : false;
            testSheet._51 = list.Contains("51") ? true : false;
            testSheet._52 = list.Contains("52") ? true : false;
            testSheet._53 = list.Contains("53") ? true : false;
            testSheet._56 = list.Contains("56") ? true : false;
            testSheet._58 = list.Contains("58") ? true : false;
            testSheet._59 = list.Contains("59") ? true : false;
            testSheet._6 = list.Contains("6") ? true : false;
            testSheet._66 = list.Contains("66") ? true : false;
            testSheet._68 = list.Contains("68") ? true : false;
            testSheet._73 = list.Contains("73") ? true : false;
            testSheet._82 = list.Contains("82") ? true : false;
            testSheet._84 = list.Contains("84") ? true : false;
        ...
        private void BindObjectToForm()
        {
            ...
            if (Convert.ToBoolean(testSheet._11))
            {
                ClickState("11");
                list.Add("11");
            }
            if (Convert.ToBoolean(testSheet._16))
            {
                ClickState("16");
                list.Add("16");
            }
            if (Convert.ToBoolean(testSheet._18))
            {
                ClickState("18");
                list.Add("18");
            }
            if (Convert.ToBoolean(testSheet._26))
            {
                ClickState("26");
                list.Add("26");
            }
            if (Convert.ToBoolean(testSheet._31))
            {
                ClickState("31");
                list.Add("31");
            }
            if (Convert.ToBoolean(testSheet._33))
            {
                ClickState("33");
                list.Add("33");
            }
            if (Convert.ToBoolean(testSheet._35))
            {
                ClickState("35");
                list.Add("35");
            }
            if (Convert.ToBoolean(testSheet._39))
            {
                ClickState("39");
                list.Add("39");
            }
            if (Convert.ToBoolean(testSheet._42))
            {
                ClickState("42");
                list.Add("42");
            }
            if (Convert.ToBoolean(testSheet._43))
            {
                ClickState("43");
                list.Add("43");
            }
            if (Convert.ToBoolean(testSheet._44))
            {
                ClickState("44");
                list.Add("44");
            }
            if (Convert.ToBoolean(testSheet._45))
            {
                ClickState("45");
                list.Add("45");
            }
            if (Convert.ToBoolean(testSheet._51))
            {
                ClickState("51");
                list.Add("51");
            }
            if (Convert.ToBoolean(testSheet._52))
            {
                ClickState("52");
                list.Add("52");
            }
            if (Convert.ToBoolean(testSheet._53))
            {
                ClickState("53");
                list.Add("53");
            }
            if (Convert.ToBoolean(testSheet._56))
            {
                ClickState("56");
                list.Add("56");
            }
            if (Convert.ToBoolean(testSheet._58))
            {
                ClickState("58");
                list.Add("58");
            }
            if (Convert.ToBoolean(testSheet._59))
            {
                ClickState("59");
                list.Add("59");
            }
            if (Convert.ToBoolean(testSheet._6))
            {
                ClickState("6");
                list.Add("6");
            }
            if (Convert.ToBoolean(testSheet._66))
            {
                ClickState("66");
                list.Add("66");
            }
            if (Convert.ToBoolean(testSheet._68))
            {
                ClickState("68");
                list.Add("68");
            }
            if (Convert.ToBoolean(testSheet._73))
            {
                ClickState("73");
                list.Add("73");
            }
            if (Convert.ToBoolean(testSheet._82))
            {
                ClickState("82");
                list.Add("82");
            }
            if (Convert.ToBoolean(testSheet._84))
            {
                ClickState("84");
                list.Add("84");
            }
        ...
        private void TsBtnSave_Click(object sender, EventArgs e)
        {
            ...
            string path = Application.StartupPath + @"\ChipPic\HPV";
            ...
            string picName = @"\ChipPic\HPV\" + DateTime.Now.ToString("yyyyMMdd") + "_" + Convert.ToString(testSheet.SampleID) + ".JPG";
            ...
            if (flag == 0)
            {
                Test_HPVBLL.Insert(testSheet); // 调用“业务逻辑层”的方法，检查有效性后插入至数据库。
                list.Clear();
                list.Add(" ");
            ...
            {
                flag = 0;
                if (Test_HPVBLL.Update(testSheet) > 0) // 调用“业务逻辑层”的方法，检查有效性后插入至数据库。
                {
        ...
        private void txt_Click(object sender, EventArgs e)
        {
            ...
            txtTestResult.Text = "HPV" + TextResult + "型感染";

            if (TextResult.Length == 0)
            {
                txtTestResult.Text = TextResult + "未感染";
            }
                        ...
                        for (int j = 0; j < Y; j = j + 2)  //  列 row          A2|B2    j=0 a1b1   j=2 c1|d1   j=4 e1f1
                        {
                            ...
                            if (listItem != null && listItem.Count != 0)
                            {
                                ...
                                if (listItem.Count == 1)
                                {
                                    ...
                                    {
                                        btn.Text = listItem[0].JudgeContent.Substring(3, listItem[0].JudgeContent.Length - 4);
        ...
        {
            FormSearch searcher = new FormSearch(judgeId,"HPV");
            searcher.ShowDialog(this);
            if(!string.IsNullOrEmpty(searcher.updateID))
            {
                Reset();
                testSheet = Test_HPVBLL.GetDataBySheetID(Convert.ToInt32(searcher.updateID));
                BindObjectToForm();
            }
        ...
        private void TsBtnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(updateID))
            {
                ...
                //{
                    instance.testSheet = Test_HPVBLL.GetDataBySheetID(Convert.ToInt32(updateID));
                    BindObjectToForm();
                //}
            }
        }
        ...
        private void TsBtnDel_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(deleteIDs))
            {
               ...
               {
                     Test_HPVBLL.Delete(deleteIDs); // 调用“业务逻辑层”的方法，删除关联对象并更新至数据库。
        ...
        private void PrintHPV(Test_HPV testSheet)
        {
            Report report = new Report();

            string fileUrl = Application.StartupPath + @"\Model\HPV.dot";
            ...
            if (!string.IsNullOrEmpty(testSheet.ChipPic))
            {
                ...
                report.InsertPicture("ChipPic", picPath, 150, 245);
            }
            ...
            string path = Application.StartupPath + @"\Document\HPV\" + DateStr;
            if (!Directory.Exists(path))
            {
                Directory.CreateDirectory(path);
            }

            string documentName = path + @"\" + DateStr + "HPV_" + Convert.ToString(testSheet.SampleID) + ".doc";
        ...
        private void BtnPrint_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < this.DgvGrid.Rows.Count; i++)
            {
                if (this.DgvGrid.Rows[i].Cells[0].EditedFormattedValue.ToString() == "True")
                {
                    ...
                    Test_HPV testSheet = Test_HPVBLL.GetDataBySheetID(myid);
                    PrintHPV(testSheet);
                }
            }
        }
        ...
        private static void BindDataGrid(string conditions)
        {
            ...
            instance.PageBar.DataSource = Test_HPVBLL.GetPageList(instance.PageBar.PageSize, instance.PageBar.CurPage, conditions);
        ...
        private void DgvGrid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(objID))
            {
                ...
                list.Clear();
                list.Add(" ");
                instance.testSheet = Test_HPVBLL.GetDataBySheetID(Convert.ToInt32(objID));
                flag = 1;
        ...
        //    }
        //    ids = ids.TrimEnd(',');
        //    FormPrint crReport = new FormPrint("Test_HPV",judgeId, ids);
        //    crReport.ShowDialog();
        //}
    }
}
